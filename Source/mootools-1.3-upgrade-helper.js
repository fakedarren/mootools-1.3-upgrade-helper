...
this.$arguments = function(i){
	console.log('method $arguments is deprecated and has no equivalent in 1.3. See the github wiki for more details');
	return function(){
		return arguments[i];
	};
};
...
this.$chk = function(obj){
	console.log('method $chk is deprecated and has no equivalent in 1.3. See the github wiki for more details');
	return !!(obj || obj === 0);
};

this.$clear = function(timer){
	console.log('method $clear is deprecated. Use clearTimeout() or clearInterval() instead');
	clearTimeout(timer);
	clearInterval(timer);
	return null;
};
...
this.$defined = function(obj){
	console.log('$defined is deprecated. Simply check if != undefined instead')
	return (obj != null);
};

this.$each = function(iterable, fn, bind){
	console.log('$each is deprecated. Use Array.each() or Object.each() instead');
	var type = typeOf(iterable);
	((type == 'arguments' || type == 'collection' || type == 'array' || type == 'elements') ? Array : Object).each(iterable, fn, bind);
};

this.$empty = function(){
	console.log('$empty is deprecated. Simply use an empty function (function(){}) instead');
};

this.$extend = function(original, extended){
	console.log('$extend is deprecated. Use Object.append() instead.');
	return Object.append(original, extended);
};

this.$H = function(object){
	console.log('$H is deprecated. Use new Hash() instead');
	return new Hash(object);
};

this.$merge = function(){
	console.log('$merge is deprecated. Use Object.merge() instead');
...
this.$lambda = function(){
	console.log('$lambda is deprecated. Use Function.from() instead');
	return Function.from(arguments);
};

this.$mixin = function(){
	console.log('$mixin is deprecated. Use Object.merge() instead');
	return Object.merge(arguments);
};

this.$random = function(){
	console.log('$random is deprecated. Use Number.random() instead');
	return Number.random();
};

this.$splat = function(){
	console.log('$splat is deprecated. Use Array.from() instead');
	return Array.from(arguments);
};

this.$time = function(){
	console.log('$time is deprecated. Use Date.now() instead');
	return Date.now();
};

this.$type = function(object){
	console.log('$type is deprecated. Use typeOf() instead');
...
Array.implement({
	...
	'extend': function(array){
		console.log('Array.extend() is deprecated. Use Array.append() instead');
...
var $pick = function(){
	console.log('$pick is deprecated. Use Array.pick() instead');
...
var $try = function(){
	console.log('$try is deprecated. Use Function.attempt() instead');
	return Function.attempt(arguments);
};
...
Browser.Engine.__defineGetter__("webkit", function(){
	console.log('Browser.Engine.webkit is deprecated, use Browser.safari or Browser.chrome instead');
	return this;
});  
Browser.Engine.__defineGetter__("trident", function(){
	console.log('Browser.Engine.trident is deprecated, use Browser.ie instead');
	return this;
});  
Browser.Engine.__defineGetter__("gecko", function(){
	console.log('Browser.Engine.gecko is deprecated, use Browser.firefox instead');
	return this;
});  
Browser.Engine.__defineGetter__("presto", function(){
	console.log('Browser.Engine.presto is deprecated, use Browser.opera instead');
	return this;
});  

this.$exec = function(){
	console.log('$exec is deprecated, use Browser.exec() instead');
	return Browser.exec();
};
...
Object.each(inserters, function(inserter, where){
	...
	methods['inject' + where] = function(el){
		console.log('Element.inject' + where + ' is deprecated, use Element.inject(el, "' + where.toLowerCase() + '" instead');
